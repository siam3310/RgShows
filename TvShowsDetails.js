...
const Trailerfunc = function (id) {
  return `<iframe class="youtubePlayer" src="https://autoembed.to/movie/imdb/${id}?trailer=1" width="100%" height="100%" loading="lazy"  frameborder="0" allowfullscreen></iframe>`;
};
