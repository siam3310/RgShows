...
import { useRGSettings } from '~/hooks/useLocalStorage';
...
const BannerItemDesktop = (props: IBannerItemDesktopProps) => {
  ...
  const { isMutedTrailer, isPlayTrailer, isFetchLogo, isShowSpotlight } = useRGSettings();
            ...
            <YouTube
              ...
              opts={{
                ...
                playerVars: {
                  ...
                  playsinline: 1,
                  mute: 1,
                  origin: 'https://rgshows.vercel.app',
                },
              }}
              onReady={({ target }) => {
