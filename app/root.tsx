...
export const meta: V2_MetaFunction<typeof loader> = () => [
  { title: 'RG Shows' },
  { name: 'description', content: 'Watching movies, series, anime and more in RG Shows' },
  {
    name: 'keywords',
    content:
      'RG SHOWS, RG Movies, RG Series, RG SHOWS Anime, RG Chill, RGShows, watch movies, watch series, watch anime, watch movies online, watch series online, watch anime online, free movies, free series, free anime, free movies online, free series online, free anime online, watch movies free, watch series free, watch anime free, watch movies online free, watch series online free, watch anime online free',
  },
  { property: 'og:url', content: 'https://rgshows.vercel.app' },
  { property: 'og:title', content: 'RG Shows' },
  { property: 'og:image', content: 'https://rgshows.vercel.app/api/ogimage?it=home' },
  { property: 'og:description', content: 'Watching movies, series, anime and more in RG' },
  { property: 'og:type', content: 'website' },
  { property: 'og:site_name', content: 'RG SHOWS' },
  { property: 'og:image:width', content: '1200' },
  { property: 'og:image:height', content: '630' },
  { name: 'twitter:card', content: 'summary_large_image' },
  { name: 'twitter:site', content: '@rgshows' },
  { name: 'twitter:image', content: 'https://rgshows.vercel.app/api/ogimage?it=home' },
  { name: 'twitter:title', content: 'RG SHOWS' },
  { name: 'twitter:description', content: 'Watching movies, series, anime and more in RG SHOWS' },
];
  ...
  React.useEffect(() => {
    if (isUpdateAvailable) {
      toast.success('Update Available', {
        description: 'A new version of rgshows is available.',
        action: {
          label: 'Update',
          onClick: () => reloadPage(),
        },
