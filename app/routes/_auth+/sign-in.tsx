...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Sign In' },
  { name: 'description', content: 'Sign in to your RG SHOWS account.' },
  { property: 'og:title', content: 'RG SHOWS - Sign In' },
  { property: 'og:description', content: 'Sign in to your RG SHOWS account.' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/sign-in' },
  { property: 'twitter:title', content: 'RG SHOWS - Sign In' },
  { property: 'twitter:description', content: 'Sign in to your RG SHOWS account.' },
]);
