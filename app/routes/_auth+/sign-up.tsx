...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Sign Up' },
  { name: 'description', content: 'Sign up for a RG SHOWS account.' },
  { property: 'og:title', content: 'RG SHOWS - Sign Up' },
  { property: 'og:description', content: 'Sign up for a RG SHOWS account.' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/sign-up' },
  { property: 'twitter:title', content: 'RG SHOWS - Sign Up' },
  { property: 'twitter:description', content: 'Sign up for a RG SHOWS account.' },
]);
...
export const action = async ({ request }: ActionArgs) => {
  ...
  return redirectWithToast(
    ...
    ref,
    {
      type: 'success',
      title: 'Sign Up Successfully',
      description: 'Welcome to RG SHOWS!',
    },
