...
export const meta = mergeMeta<{}, { 'routes/anime+/$animeId': typeof animeIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      ...
      { property: 'og:url', content: `https://rgshows.vercel.app/anime/${params.animeId}` },
      { property: 'og:title', content: `RG SHOWS - ${animeTitle}` },
      {
      ...
      { name: 'twitter:title', content: `RG SHOWS - ${animeTitle}` },
      {
