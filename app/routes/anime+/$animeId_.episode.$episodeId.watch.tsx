...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `RG SHOWS - Watch ${animeTitle} episode ${episodeInfo?.number || ''}` },
    {
      name: 'description',
      content: description
    ...
    {
      property: 'og:url',
      content: `https://rgshows.vercel.app/anime/${params.animeId}/episode/${params.episodeId}/watch`,
    },
    {
      property: 'og:title',
      content: `RG SHOWS - Watch ${animeTitle} episode ${episodeInfo?.number || ''}`,
    },
    {
