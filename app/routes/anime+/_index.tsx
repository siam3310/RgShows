...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Anime' },
  { name: 'description', content: 'Discover anime in RG SHOWS' },
  { property: 'og:url', content: 'https://rgshow.vercel.app/anime' },
  { property: 'og:title', content: 'RG SHOWS - Anime' },
  { property: 'og:description', content: 'Discover anime in RG SHOWS' },
  { name: 'twitter:title', content: 'RG SHOWS - Anime' },
  { name: 'twitter:description', content: 'Discover anime in RG SHOWS' },
]);
