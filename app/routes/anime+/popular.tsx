...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Popular Anime' },
  { name: 'description', content: 'Popular Anime' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/anime/popular' },
  { property: 'og:title', content: 'RG SHOWS - Popular Anime' },
  { property: 'og:description', content: 'Popular Anime' },
  { name: 'twitter:title', content: 'RG SHOWS - Popular Anime' },
