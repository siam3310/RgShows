...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Recent Anime Episodes' },
  { name: 'description', content: 'Recent Anime Episodes' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/anime/recent-episodes' },
  { property: 'og:title', content: 'RG SHOWS - Recent Anime Episodes' },
  { property: 'og:description', content: 'Recent Anime Episodes' },
  { name: 'twitter:title', content: 'RG SHOWS - Recent Anime Episodes' },
