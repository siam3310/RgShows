...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Trending Anime' },
  { name: 'description', content: 'Trending Anime' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/anime/trending' },
  { property: 'og:title', content: 'RG SHOWS - Trending Anime' },
  { property: 'og:description', content: 'Trending Anime' },
  { name: 'twitter:title', content: 'RG SHOWS - Trending Anime' },
