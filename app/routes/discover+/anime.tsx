...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Discover anime' },
  { name: 'description', content: 'Discover Anime on RG SHOWS' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/discover/anime' },
  { property: 'og:title', content: 'RG SHOWS - Discover anime' },
  { property: 'og:image', content: 'https://rgshows.vercel.app/api/ogimage?it=anime' },
  { property: 'og:description', content: 'Discover Anime on RG SHOWS' },
  { name: 'twitter:title', content: 'RG SHOWS - Discover anime' },
  { name: 'twitter:description', content: 'Discover Anime on RG SHOWS' },
  { name: 'twitter:image', content: 'https://rgshows.vercel.app/api/ogimage?it=anime' },
]);
