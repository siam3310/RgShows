...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Discover movies' },
  { name: 'description', content: 'Discover Movies on RG SHOWS' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/discover/movies' },
  { property: 'og:title', content: 'RG SHOWS - Discover movies' },
  { property: 'og:image', content: 'https://rgshows.vercel.app/api/ogimage?it=movies' },
  { property: 'og:description', content: 'Discover Movies on RG SHOWS' },
  { name: 'twitter:title', content: 'RG SHOWS - Discover movies' },
  { name: 'twitter:description', content: 'Discover Movies on RG SHOWS' },
  { name: 'twitter:image', content: 'https://rgshows.vercel.app/api/ogimage?it=movies' },
]);
