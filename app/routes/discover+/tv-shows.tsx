...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Discover tv shows' },
  { name: 'description', content: 'Discover tv shows on RG SHOWS' },
  { property: 'og:url', content: 'https://rgshowschill.vercel.app/discover/tv-shows' },
  { property: 'og:title', content: 'RG SHOWS - Discover tv shows' },
  { property: 'og:image', content: 'https://rgshows.vercel.app/api/ogimage?it=tvshows' },
  { property: 'og:description', content: 'Discover tv shows on RG SHOWS' },
  { name: 'twitter:title', content: 'RG SHOWS - Discover tv shows' },
  { name: 'twitter:description', content: 'Discover tv shows on RG SHOWS' },
  { name: 'twitter:image', content: 'https://rgshows.vercel.app/api/ogimage?it=tvshows' },
]);
