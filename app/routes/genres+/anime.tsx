...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS Anime - Genres' },
  { name: 'description', content: 'Anime Genres' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/genres/anime' },
  { property: 'og:title', content: 'RG SHOWS Anime - Genres' },
  { property: 'og:image', content: 'https://rgshows.vercel.app/api/ogimage?it=anime' },
  { property: 'og:description', content: 'Anime Genres' },
  { name: 'twitter:title', content: 'RG SHOWS Anime - Genres' },
