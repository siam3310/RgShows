...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS Movies - Genres' },
  { name: 'description', content: 'Movies Genres' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/genres/movies' },
  { property: 'og:title', content: 'RG SHOWS Movies - Genres' },
  { property: 'og:image', content: 'https://rgshows.vercel.app/api/ogimage?it=movies' },
  { property: 'og:description', content: 'Movies Genres' },
  { name: 'twitter:title', content: 'RG SHOWS Movies - Genres' },
