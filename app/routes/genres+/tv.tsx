...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS Tv shows - Genres' },
  { name: 'description', content: 'Tv shows Genres' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/genres/tv' },
  { property: 'og:title', content: 'RG SHOWS Tv shows - Genres' },
  { property: 'og:image', content: 'https://rgshows.vercel.app/api/ogimage?it=tvshows' },
  { property: 'og:description', content: 'Tv shows Genres' },
  { name: 'twitter:title', content: 'RG SHOWS Tv shows - Genres' },
