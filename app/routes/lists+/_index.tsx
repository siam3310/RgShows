...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Featured Lists' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/lists/' },
  { property: 'og:title', content: 'RG SHOWS - Featured Lists' },
  { name: 'twitter:title', content: 'RG SHOWS - Featured Lists' },
]);
