...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `RG SHOWS - ${movieTitle} - Cast` },
      {
        property: 'og:url',
        content: `https://rgshows.vercel.app/movies/${params.movieId}/cast`,
      },
      { property: 'og:title', content: `RG SHOWS - ${movieTitle} - Cast` },
      { name: 'twitter:title', content: `RG SHOWS - ${movieTitle} - Cast` },
    ];
  },
);
