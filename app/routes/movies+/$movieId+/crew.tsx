...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `RG SHOWS - ${movieTitle} - Crew` },
      {
        property: 'og:url',
        content: `https://rgshows.vercel.app/movies/${params.movieId}/crew`,
      },
      { property: 'og:title', content: `RG SHOWS - ${movieTitle} - Crew` },
      { name: 'twitter:title', content: `RG SHOWS - ${movieTitle} - Crew` },
    ];
  },
);
