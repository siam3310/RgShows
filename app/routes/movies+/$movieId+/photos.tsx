...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `RG SHOWS - ${movieTitle} - Photos` },
      {
        property: 'og:url',
        content: `https://rgshows.vercel.app/movies/${params.movieId}/photos`,
      },
      { property: 'og:title', content: `RG SHOWS - ${movieTitle} - Photos` },
      { name: 'twitter:title', content: `RG SHOWS - ${movieTitle} - Photos` },
    ];
  },
);
