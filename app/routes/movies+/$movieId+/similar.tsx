...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `RG SHOWS - ${movieTitle} - Similar` },
      {
        property: 'og:url',
        content: `https://rgshows.vercel.app/movies/${params.movieId}/similar`,
      },
      { property: 'og:title', content: `RG SHOWS - ${movieTitle} - Similar` },
      { name: 'twitter:title', content: `RG SHOWS - ${movieTitle} - Similar` },
    ];
  },
);
