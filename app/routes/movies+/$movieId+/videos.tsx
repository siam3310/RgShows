...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `RG SHOWS - ${movieTitle} - Videos` },
      {
        property: 'og:url',
        content: `https://rgshows.vercel.app/movies/${params.movieId}/videos`,
      },
      { property: 'og:title', content: `RG SHOWS - ${movieTitle} - Videos` },
      { name: 'twitter:title', content: `RG SHOWS - ${movieTitle} - Videos` },
    ];
  },
);
