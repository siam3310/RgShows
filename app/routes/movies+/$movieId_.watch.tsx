...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `RG SHOWS - Watch ${movieTitle}` },
    ...
    { property: 'og:url', content: `https://rgshows.vercel.app/movies/${params.movieId}/watch` },
    { property: 'og:title', content: `RG SHOWS - Watch ${movieTitle}` },
    { property: 'og:description', content: overview },
    {
      property: 'og:image',
      content: `https://rgshows.vercel.app/api/ogimage?m=${params.movieId}&mt=movie`,
    },
    { name: 'twitter:title', content: `RG SHOWS - Watch ${movieTitle}` },
