...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Movies' },
  { name: 'description', content: 'Discover movies in RG SHOWS' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/movies/' },
  { property: 'og:title', content: 'RG SHOWS - Movies' },
  { property: 'og:description', content: 'Discover movies in RG SHOWS' },
  { name: 'twitter:title', content: 'RG SHOWS - Movies' },
  { name: 'twitter:description', content: 'Discover movies in RG SHOWS' },
]);
