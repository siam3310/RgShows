...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Now Playing Movies' },
  { name: 'description', content: 'Now Playing Movies' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/movies/now-playing' },
  { property: 'og:title', content: 'RG SHOWS - Now Playing Movies' },
  { property: 'og:description', content: 'Now Playing Movies' },
  { name: 'twitter:title', content: 'RG SHOWS - Now Playing Movies' },
