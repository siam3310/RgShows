...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Popular Movies' },
  { name: 'description', content: 'Popular Movies' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/movies/popular' },
  { property: 'og:title', content: 'RG SHOWS - Popular Movies' },
  { property: 'og:description', content: 'Popular Movies' },
  { name: 'twitter:title', content: 'RG SHOWS - Popular Movies' },
