...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Top Rated Movies' },
  { name: 'description', content: 'Top Rated Movies' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/movies/top-rated' },
  { property: 'og:title', content: 'RG SHOWS - Top Rated Movies' },
  { property: 'og:description', content: 'Top Rated Movies' },
  { name: 'twitter:title', content: 'RG SHOWS - Top Rated Movies' },
