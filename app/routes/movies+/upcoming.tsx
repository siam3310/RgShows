...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Upcoming Movies' },
  { name: 'description', content: 'Upcoming Movies' },
  { property: 'og:url', content: 'https://rgshows.vercel.app/movies/upcoming' },
  { property: 'og:title', content: 'RG SHOWS - Upcoming Movies' },
  { property: 'og:description', content: 'Upcoming Movies' },
  { name: 'twitter:title', content: 'RG SHOWS - Upcoming Movies' },
