...
export const meta = mergeMeta<null, { 'routes/people+/$peopleId': typeof peopleIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `RG SHOWS - ${peopleTitle}` },
      {
        property: 'og:url',
        content: `https://rgshows.vercel.app/people/${params.peopleId}/`,
      },
      { property: 'og:title', content: `RG SHOWS - ${peopleTitle}` },
      { name: 'twitter:title', content: `RG SHOWS - ${peopleTitle}` },
    ];
  },
);
