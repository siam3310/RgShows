...
export const meta = mergeMeta<null, { 'routes/people+/$peopleId': typeof peopleIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `RG SHOWS - ${peopleTitle} - Credits` },
      {
        property: 'og:url',
        content: `https://rgshows.vercel.app/people/${params.peopleId}/credits`,
      },
      { property: 'og:title', content: `RG SHOWS - ${peopleTitle} - Credits` },
      { name: 'twitter:title', content: `RG SHOWS - ${peopleTitle} - Credits` },
    ];
  },
);
