...
export const meta = mergeMeta<null, { 'routes/people+/$peopleId': typeof peopleIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `RG SHOWS - ${peopleTitle} - Media` },
      {
        property: 'og:url',
        content: `https://rgshows.vercel.app/people/${params.peopleId}/media`,
      },
      { property: 'og:title', content: `RG SHOWS - ${peopleTitle} - Media` },
      { name: 'twitter:title', content: `RG SHOWS - ${peopleTitle} - Media` },
    ];
  },
);
