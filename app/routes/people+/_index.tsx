...
export const meta = mergeMeta(() => [
  { title: 'RG SHOWS - Popular People' },
  { name: 'description', content: 'Discover the most popular celebrities on RG SHOWS.' },
  {
    name: 'keywords',
    content:
  ...
  { property: 'og:url', content: 'https://rgshows.vercel.app/people' },
  { property: 'og:title', content: 'RG SHOWS - Popular People' },
  { property: 'og:image', content: 'https://rgshows.vercel.app/api/ogimage?it=people' },
  { property: 'og:description', content: 'Discover the most popular celebrities on RG SHOWS.' },
  { name: 'twitter:title', content: 'RG SHOWS - Popular People' },
  { name: 'twitter:description', content: 'Discover the most popular celebrities on RG SHOWS.' },
  { name: 'twitter:image', content: 'https://rgshows.vercel.app/api/ogimage?it=people' },
]);
