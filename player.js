...
const Trailerfunc = function (id) {
  return `<iframe class="youtubePlayer" src="https://embed.smashystream.com/playere.php?tmdb=${id}" width="100%" height="100%" loading="lazy" frameborder="0" allowfullscreen></iframe>`;
};
...
const html2 = function (moviee) {
  ...
  let url = "player?id=" + encodeURIComponent(movie.id);
  let cate = "";
  ...
  return `<div class="movie_details">
    ...
    <div class="movie_details_about">
        ...
        <div class="playButtonContainer"> 
            <span > <a class="playLink" href="./player.html"><button class="play_btn"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19"
